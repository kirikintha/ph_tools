...
(function(jQuery) {
    ...
    jQuery.fn.extend({
        orbitaltooltip: function(options) {
            ...
            var orbTooltip 		= this;
            var uniqueID 		= 'orbitalTip_' + this.attr("id");
                ...
                function(e) {
                	if (options.orbit == true) {
                		...
                		*/
                		...
                		position(jQuery("#" + uniqueID), e.pageX+15, e.pageY-90);
                	}
                },
                function(e) {
					// off hover
	...
	function calculatePosition(element_to_add_tooltip, tooltip, orbitalPosition, spacing, offset)
	{
		...
		//console.log('element center: '+element_center);
		//console.log('tooltip center: '+tooltip_center);
